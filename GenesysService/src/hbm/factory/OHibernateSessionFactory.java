...
public class OHibernateSessionFactory {
	static Logger logger = Logger.getLogger( OHibernateSessionFactory.class.getName());
	private static String CONFIG_FILE_LOCATION = "ohibernate.cfg.xml";
	...
	private OHibernateSessionFactory() {
	}
