Ext.define('Tab.view.newreport.reportAgentInOutView', {
	extend: 'Ext.grid.Panel',
	xtype: 'reportAgentInOutView',

	requires: [
		'Tab.view.newreport.reportAgentInOutController',
		'Tab.view.newreport.reportAgentInOutModel',
		'Tab.view.newreport.ReportAgentInOutStore',
	...
	controller: 'newreport-reportagentinout',
	viewModel: {
		type: 'newreport-reportagentinout'
	},
	plugins: {
        gridexporter: true
    },
	store: Ext.create('Tab.view.newreport.ReportAgentInOutStore'),
	grouped: true,
	collapsible: true,
    collapseFirst: false,
    features: [
						...
						listeners: {
							'click': function () {
								...
								grid.store.proxy.extraParams = {
									...
									inbound: me.down('combobox[fieldLabel="呼叫方向"]').getValue(),
									nType: me.down('combobox[fieldLabel="呼叫类型"]').getValue(),
									weekend: 0,
									length: me.down('textfield[fieldLabel="通话时长"]').getValue(),
