Ext.define("Tab.view.report.reportInvestigateSummaryView", {
  extend: "Ext.grid.Panel",
  xtype: "reportInvestigateSummaryView",
  //通快 坐席满意度汇总
  requires: [
    "Tab.view.report.reportInvestigateSummaryViewController",
    "Tab.view.report.reportInvestigateSummaryViewModel",
    "Tab.view.report.reportInvestigateSummaryViewStore",
    "Ext.form.field.Spinner",
    "Ext.form.RadioGroup",
    "Ext.form.field.Radio",
  ],

  controller: "report-reportinvestigatesummaryview",
  store: Ext.create("Tab.view.report.reportInvestigateSummaryViewStore"),
  tbar: {
    autoScroll: true,
    items: [
      {
          ...
          },
          {
            ...
            handler: function () {
              ...
              form.submit({
                ...
                params: {
                  script: path + "ReportInvestigateSummaryExport.js",
                  starttime:
                    me
                      .down('datetimetowfield[name="starttime"]')
                      .getSubmitValue() + ":00",
