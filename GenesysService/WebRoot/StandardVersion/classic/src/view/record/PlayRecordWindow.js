Ext.define('Tab.view.record.PlayRecordWindow', {
	...
	makeVoiceMailPlay: function (url, title, recordid) {
		var me = this;
		// url="http://127.0.0.1:9999/record/20230417/record-20230417_19_35_55-17351438332-02152690373-008OS1L3209GF5T32LUHVB5AES0192FA.wav";
		if (!Ext.isIE) {
			me.recordid = recordid;
			me.setTitle(me.origintitle + '-' + title);
			me.audioUrl = url;
